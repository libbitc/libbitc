...
const char *argp_program_version =
	"bitsy " PACKAGE_VERSION "\n"
	"Copyright 2016 libbitc\n"
...
static char global_doc[] =
	...
	"\n"
	"Run \"bitsy cmd --help\" for extended, per-command help.\n"
	"\n"
	"Global options:\n";
...
{
	struct lsi_info lsi = { bitc_hashtab_size(settings), };
