#ifndef __LIBBITC_MESSAGE_H__
#define __LIBBITC_MESSAGE_H__
...
struct msg_version {
	...
	uint64_t	nServices;
	int64_t		nTime;
	struct bitc_address addrTo;
	struct bitc_address addrFrom;
	uint64_t	nonce;
	char		strSubVer[80];
